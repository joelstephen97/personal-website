            ...
            <div class="flex items-center gap-2">
              <div class="relative flex items-center">
                ...
                >
                  ...
                  />
                  <Icon
                    v-else-if="voiceSearch.isListening.value"
                    name="Square"
                    :size="18"
                  />
...
const hobbiesData = [
  ...
  },
  {
    ...
    title: "Game of Life",
    description:
      "Conway's cellular automaton with presets and canvas rendering.",
  ...
  },
  {
    ...
    title: "Regex Tester",
    description:
      "Real-time regex matching with highlighted results and capture groups.",
  ...
  },
  {
    ...
    description:
      "Split-pane editor with live preview powered by a hand-rolled parser.",
  ...
  {
    id: 18,
    slug: "local-file-editor",
    title: "Local File Editor",
    description: "Edit text files directly on disk via File System Access API.",
    link: "/project/local-file-editor",
    cta: "Edit files",
    icon: "FilePen",
    tech: ["Web API", "Dev Tools"],
  },
];
...
function buildHobbiesFromOrder(order: number[], pinned: number[]) {
  ...
  const remaining = hobbiesData.filter((p) => !fullOrder.includes(p.id));
...
function onDragEnd(event: {
  ...
  if (
    ...
    if (targetProjectId && stashedIds.value.includes(targetProjectId)) {
