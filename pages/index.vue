      ...
      <div class="container space-y-10 xl:space-y-16">
        <div class="grid gap-4 md:grid-cols-2 md:gap-16">
          <div>
            ...
            <div
              class="max-w-[700px] mx-auto my-5 bg-gray-800 rounded-lg overflow-hidden shadow-lg"
            >
              <div class="bg-gray-700 px-4 py-2 flex items-center">
                <button
                  class="w-3 h-3 rounded-full bg-red-500 mr-2 focus:outline-none"
                  @click="toggleMinimize"
                />
                <button
                  class="w-3 h-3 rounded-full bg-yellow-500 mr-2 focus:outline-none"
                  @click="toggleMinimize"
                />
                <button
                  class="w-3 h-3 rounded-full bg-green-500 focus:outline-none"
                  @click="toggleMinimize"
                />
              </div>
              ...
              >
                <div class="flex flex-col space-y-4">
                  <UButton
                    ...
                    variant="solid"
                    size="xl"
                    @click="onClickFrontend"
                    >Front-end Stack</UButton
                  >
                  <div
                    v-if="frontendSelected"
                ...
                <div class="flex flex-col space-y-4">
                  <UButton
                    ...
                    variant="solid"
                    size="xl"
                    @click="onClickBackend"
                    >Back-end Stack</UButton
                  >
                  <div
                    v-if="backendSelected"
                    class="sm:hidden grid max-w-[700px] grid-cols-1 gap-4"
                  >
                    <div
              ...
              >
                ...
                >
                  ...
                  <p class="text-white dark:text-white">
                    ...
                    {{
                      calculateDuration(item.start, item.end) === 1
                        ? "year"
                        : "years"
                    }}
                  </p>
...
const backendTech = [{ name: "Python" }, { name: "PHP" }, { name: "Java" }];
