<template>
    <UContainer>
        <div class="w-full pt-10 md:pt-24 lg:pt-32 flex-row pb-10">
            <h1 class="lg:leading-tighter pb-2 text-4xl font-bold tracking-tighter sm:text-2xl md:text-4xl xl:text-6xl 2xl:text-6xl -mt-8 md:-mt-20">
              Experience
            </h1>
        </div>
        <div class="container mx-auto p-4 -mt-8 mb-20">
            <template v-for="exp in experiencesList">
                <JobExperiences
                    :title="exp.title"
                    :company="exp.company"
...
const experiencesList = [
    ...
    },
    {
        ...
        location: 'Dubai, United Arab Emirates',
        duration: 'May 2020 - Feb 2023 · 2 years 10 months',
        tasks: [
        ...
        skills: ['Requirements Analysis','Fullstack Web Development','JSON Web Token (JWT)','Git','PHP','Jira','Reactjs','Nextjs'],
    },
    {
        ...
        skills: [
            'Software Development','Airtable','JIRA','Google Analytics','Confluence','Python','Vend'
        ],
    },
    {
        ...
        skills: ['Django','Flask','MySQL','SQLite','Javascript','HTML5/CSS','jQuery','git'],
    },
]
