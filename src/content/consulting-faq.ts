...
export const consultingFaq: ConsultingFaqEntry[] = [
  {
    ...
    a: "I work with whichever model provider you already use. The pipeline itself is built against more than one provider by default, so it stays portable if a provider or model changes later.",
  },
  {
    id: "not-sure",
    q: "What if we're not sure AI is the right answer yet?",
    a: "That's what the roadmapping session is for. It maps the candidate workflows against what a model can actually do today, and a plain 'do not build it' is as valid an outcome as a build plan.",
  },
  {
    id: "nda",
    q: "Do you sign NDAs?",
  ...
  },
  {
    ...
    a: "Abu Dhabi, GMT+4, working remotely. Calls and overlap windows are scheduled against that time zone, usually early morning or evening depending on where the team sits.",
  },
  {
    id: "billing",
    q: "Do you bill hourly?",
    a: "No. Every engagement is a fixed fee or a stated monthly cadence, agreed before the work starts, never a running hourly meter.",
  },
];
