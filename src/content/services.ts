...
export const services = Service.array().parse([
  {
    ...
    step: 1,
    answer:
      "This is a 90-minute working session on your product, followed by a written plan within two days. It's for a team that knows AI could help somewhere but hasn't pinned down where it earns its cost or how it fails, and wants that answered before anyone writes a line of pipeline code.",
    problem:
  ...
  },
  {
    ...
    step: 2,
    answer:
      "I design and build one AI-assisted workflow end to end: the pipeline, the retrieval or prompting it actually needs, the guardrails, and the interface people run it from. It's for a team with a defined workflow that needs a model in the loop, whose engineers haven't taken an LLM feature from prototype to production before.",
    problem:
  ...
  },
  {
    ...
    step: 2,
    answer:
      "I build the system that runs several AI-assisted steps together: task sequencing, human-in-the-loop checkpoints, retries, and an interface for people to monitor and step in. It's for a team whose AI-assisted process has outgrown a single script someone babysits and needs to run as software instead.",
    problem:
  ...
  },
  {
    ...
    step: 2,
    answer:
      "I design the collaborative data layer, conflict resolution, presence, and versioning behind a document, board, or canvas, and the interface that makes concurrent editing feel safe. It's for a product team whose single-user data model won't hold now that more than one person needs to work on the same thing at once.",
    problem:
  ...
  },
  {
    ...
    step: 2,
    answer:
      "I build a working prototype of the interface first, wired to real or realistic data, so the product gets tested before the backend gets built. It's for a founder or product team with an idea that needs to be in front of users or investors before the budget for a full backend exists.",
    problem:
  ...
  },
  {
    ...
    step: 3,
    answer:
      "I test an AI feature already in production against real and adversarial inputs, measure its failure modes, and hand over a prioritized list of fixes. It's for a team that has shipped an AI feature and can no longer say with confidence how often it's wrong or why.",
    problem:
  ...
  },
  {
    ...
    step: 3,
    answer:
      "I read the codebase, trace the data flow, and deliver a written review of what to keep, what to change, and what to watch. It's for a team whose codebase has grown past the point where the original decisions still fit and wants a second opinion before the next big feature.",
    problem:
  ...
  },
  {
    ...
    step: 3,
    answer:
      "I run hands-on sessions with a frontend or product team on the AI tooling that speeds up real engineering work, using their own codebase as the material. It's for a team starting to bring AI tooling into daily work without a shared sense yet of what actually helps.",
    problem:
  ...
  },
  {
    ...
    step: 4,
    answer:
      "I embed as an engineer on your team for an agreed cadence, shipping alongside them and keeping the original plan honest as scope shifts. It's for a team with a build already in progress that needs an extra senior engineer for a stretch, not a handoff document.",
    problem:
