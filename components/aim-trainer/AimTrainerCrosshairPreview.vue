<template>
  ...
  >
    <template v-if="preview.style === 'cross' || preview.style === 'cross-dot'">
      <div class="absolute bg-current" :style="preview.bars.v1" />
      <div class="absolute bg-current" :style="preview.bars.v2" />
      <div class="absolute bg-current" :style="preview.bars.h1" />
      <div class="absolute bg-current" :style="preview.bars.h2" />
    </template>
    <div
